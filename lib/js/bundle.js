...
var DrumMachine = function () {
  ...
  _createClass(DrumMachine, [{
    ...
    value: function createGrid() {
      var BUTTONS = 16;
      var SOUNDS = [BD, SD, CH, OH, CB, CP];

      var _loop = function _loop(i) {
        var $row = $('<ul class=\'row\'>');

        var _loop2 = function _loop2(j) {
          var $beat = $('<li class=\'col' + j + '\'><div class=\'led\'></li>');
          $beat.click(function () {
...
var DrumLoop = function () {
  ...
  _createClass(DrumLoop, [{
    ...
    value: function loop(bpm) {
      ...
      var column = $('li.col' + this.currentNote);
...
var instruments = exports.instruments = function instruments() {
  var list = ['Bass Drum', 'Snare Drum', 'Closed Hi hat', 'Open Hi hat', 'Cow Bell', 'ClaP'];
